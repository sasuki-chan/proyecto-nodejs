...
app.controller('controlador_de_tablas', ['$scope', '$http','socket','$window','$interval', function($scope,$http,socket,$window,$interval){
    ...
    $http.get("/mostrar_notas").success(function(response){
    ...
    socket.on('datos_actualizados_notas',function(data){
    ...
    $scope.exportData = function () {
        ...
        saveAs(blob, "reporte_listado_notas.xls");
    };
    ...
    $scope.update = function(datos){
        ...
        socket.emit('actualizar_nota', data);
